...
// Marshal serializes the header into a byte slice with HMAC protection.
// Structure: [Magic][Salt][HeaderData][MAC]
func (h *Header) Marshal(salt, key []byte) ([]byte, error) {
	...
	// Serialize header fields to binary format
...
// serialize converts the header fields to binary format using big-endian encoding.
